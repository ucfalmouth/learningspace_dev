...
$sentNav = new moodle_url('/blocks/moodletxt/sent.php', array(
    'course'    => $courseId, 
    'instance'  => $instanceId
));

$PAGE->navbar->add(get_string('navmoodletxt', 'block_moodletxt'), null, navigation_node::TYPE_CUSTOM, 'moodletxt');
$PAGE->navbar->add(get_string('navsent', 'block_moodletxt'), $sentNav, navigation_node::TYPE_CUSTOM, 'moodletxt');
$PAGE->navbar->add(get_string('navstatus', 'block_moodletxt'), null, navigation_node::TYPE_CUSTOM, 'moodletxt');
