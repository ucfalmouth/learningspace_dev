...
/**
 * Endpoint for JSON calls for Moodle user searcher
 * 
...
require_once($CFG->dirroot . '/blocks/moodletxt/ajax/TxttoolsUserSearchJSONHandler.php');
...
$handler = new TxttoolsUserSearchJSONHandler();
