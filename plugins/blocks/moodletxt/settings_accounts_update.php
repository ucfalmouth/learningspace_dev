...
/**
 * Endpoint for JSON calls from account settings page.
 * 
...
require_once($CFG->dirroot . '/blocks/moodletxt/ajax/TxttoolsAccountJSONHandler.php');
...
$handler = new TxttoolsAccountJSONHandler();
