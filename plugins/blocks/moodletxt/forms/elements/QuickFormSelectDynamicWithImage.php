...
/**
 * File container for QuickFormSelectDynamicWithImage class
 * 
...
require_once($CFG->dirroot . '/blocks/moodletxt/forms/elements/QuickFormSelectDynamic.php');
require_once($CFG->dirroot . '/blocks/moodletxt/renderer.php');

/**
 * Overridden PEAR select element with optional image tacked on.
 ...
 * @since 2011070501
 */
class QuickFormSelectDynamicWithImage extends QuickFormSelectDynamic {
     ...
     * @since 2011070501
     */
    public function __construct($elementName=null, $elementLabel=null, $options=null, $attributes=null, moodletxt_icon $icon=null) {
     ...
     * @since 2011070501
     */
    public function QuickFormSelectDynamicWithImage($elementName=null, $elementLabel=null, $options=null, $attributes=null, moodletxt_icon $icon=null) {
        $this->__construct($elementName, $elementLabel, $options, $attributes, $icon);
    }
