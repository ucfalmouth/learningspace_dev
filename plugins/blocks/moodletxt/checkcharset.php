...
/**
 * Endpoint for JSON calls requesting character set checks
 * 
...
require_once($CFG->dirroot . '/blocks/moodletxt/ajax/MoodletxtCharsetJSONHandler.php');

// Prevent page code being echoed by simply not including any of it!

$json = stripslashes(required_param('json', PARAM_RAW));
$handler = new MoodletxtCharsetJSONHandler();
