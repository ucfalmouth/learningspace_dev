...
/**
 * Endpoint for JSON calls inbox page
 * 
...
require_once($CFG->dirroot . '/blocks/moodletxt/ajax/MoodletxtInboxJSONHandler.php');
...
$handler = new MoodletxtInboxJSONHandler();

// Set valid JSON MIME header for response
header('Content-Type: application/json; charset=utf-8');

try {
    $response = $handler->processJSON($json, $USER->id);
    echo($response);
